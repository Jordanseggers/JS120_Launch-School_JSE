...
Player.INITIAL_PURSE = 5;
Player.WINNING_PURSE = 2 * Player.INITIAL_PURSE;
...
TwentyOneGame.DEALER_MUST_STAY_SCORE = this.TARGET_SCORE - 4;
TwentyOneGame.HIT = "h";
TwentyOneGame.STAY = "s";
